...
export function FileExplorer() {
  ...
  // ⚡ Bolt: Memoized onSelect handler with useCallback to ensure stable function identity
  // across renders, preventing unnecessary re-renders of the memoized FileRow children.
