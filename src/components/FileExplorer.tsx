...
const FileRow = memo(function ({ node, depth, selectedId, onSelect }: FileRowProps) {
  ...
  // Always re-render folder nodes to allow props (like selectedId) to propagate to their children.
  if (nextProps.node.type === 'folder') return false;

  // For file nodes, compare derived selection state rather than global selectedId
