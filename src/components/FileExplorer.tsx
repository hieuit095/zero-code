...
const FileRow = memo(function FileRowComponent({ node, depth, selectedId, onSelect }: FileRowProps) {
  ...
  // Always re-render folders to propagate expanded state and new selections to children
...
export function FileExplorer() {
  ...
  // ⚡ Bolt: Memoized selection handler to preserve stable identity when passed to memoized children
