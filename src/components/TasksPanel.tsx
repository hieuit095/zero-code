...
// ⚡ Bolt: Extracted and memoized TaskItem to prevent O(N) re-renders
// during high-frequency status updates, matching the pattern in .jules/bolt.md
const TaskItem = React.memo(function TaskItem({ task, isExpanded, isRetrying, onToggle }: TaskItemProps) {
  return (
